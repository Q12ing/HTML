...
//배열의 전체 개수 lenght 속성은 1부터 인식한다.
console.log(yoil.length);
//yoil 배열 데이터 개수는 7개 이다.
console.log(`yoil 배열 데이터 개수는 ${yoil.length}개이다.`);
//배열 생성과 호출 연습
let colorSet = ['파랑','보라','핑크','빨강','검정']
console.log(colorSet[3], colorSet[4], colorSet[1]); //랜덤하게 3개
let fruits = ['바나나','딸기','귤','사과','수박','오렌지','복숭아']
//주문 하신 상품은 복숭아, 오렌지. 수박. 귤, 사과, 딸기, 바나나 총 7개 입니다.
console.log(`주문 하신 상품은 ${fruits[6]}, ${fruits[5]}, ${fruits[4]}, ${fruits[3]}, ${fruits[2]}, ${fruits[1]}, ${fruits[0]} 총 ${fruits.length}개 입니다.`);
...
numbers.shift(); //배열의 시작 값 숫자데이터 제거
console.log(numbers); // 5 6 7 8
numbers.push(9);
numbers.push(10);
console.log(numbers);
...
//2. 인원 추가에 따라 배여렝 좌석값이 들어갈 수 있는 저장소가 추가된다.
...
console.log(`총 인원은 ${megabox.length}명이고 최종 결제 금액은 ${megabox.length*megaboxPrice}원 입니다.`);
//카페 제공 메뉴와 장바구니
console.log('======================================')
...
//최종 결제 금액은 ?원입니다.
console.log(`최종 결제 금액은 ${cart.length*coffeePrice}입니다.`);
console.log('======================================')
//=====================배열 작성 문법 연습
