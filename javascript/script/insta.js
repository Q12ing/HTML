...
console.log(typeof (likeIcon, commentIcon, paperIcon));

function iconSrc(target,category,status){
    return target.src = `./images/${category}_${status}.png`;
}
